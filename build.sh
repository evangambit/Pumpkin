...
# Build command
g++ $CXXFLAGS -o $1 $2 $(find src/ -name "*.cpp" | grep -Ev "(Tests|[Mm]ain|make_tables|make_moveorder_tables)\\.cpp") $INCLUDE_FLAGS $LDFLAGS model_data.cpp qst_data.cpp byhand_data.cpp ${@:3}

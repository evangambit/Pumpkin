...
# Build command
g++ $CXXFLAGS -o $1 $2 $(find src/ -name "*.cpp" | grep -Ev "(Tests|uci|main|make_tables|pgns2fens|make_moveorder_tables)\\.cpp") $INCLUDE_FLAGS $LDFLAGS model_data.cpp qst_data.cpp ${@:3}
